...
export const mockActivityLeads: ActivityLead[] = [
  {
    ...
    status: "Processed",
    timeline: [
      { time: "9:14 AM", event: "Lead scanned from hipages" },
      { time: "9:14 AM", event: "Keywords matched: roof, replacement, tile roof, urgent" },
      { time: "9:14 AM", event: "Score computed: 75" },
      { time: "9:14 AM", event: "Decision: Accept (threshold 40)" },
      { time: "9:15 AM", event: "Lead marked as Processed" },
    ],
  },
  {
    id: "al-2",
    ...
    status: "Scanned",
    timeline: [
      { time: "9:02 AM", event: "Lead scanned from Oneflare" },
      { time: "9:02 AM", event: "Keywords matched: roof, leak, repair" },
      { time: "9:02 AM", event: "Score computed: 35" },
      { time: "9:02 AM", event: "Decision: Review (threshold 20, below accept 40)" },
    ],
  },
  {
    id: "al-3",
    ...
    status: "Processed",
    timeline: [
      { time: "8:45 AM", event: "Lead submitted via Roofix Website form" },
      { time: "8:45 AM", event: "Keywords matched: roof, gutter" },
      { time: "8:45 AM", event: "Score computed: 50" },
      { time: "8:46 AM", event: "Decision: Accept (threshold 40)" },
      { time: "8:46 AM", event: "Lead marked as Processed" },
    ],
  },
  {
    id: "al-4",
    ...
    status: "Processed",
    timeline: [
      { time: "8:28 AM", event: "Lead scanned from hipages" },
      { time: "8:28 AM", event: "Keywords matched: roof, terracotta, replacement" },
      { time: "8:28 AM", event: "Score computed: 65" },
      { time: "8:28 AM", event: "Decision: Accept (threshold 40)" },
      { time: "8:29 AM", event: "Lead marked as Processed" },
    ],
  },
  {
    id: "al-5",
    ...
    status: "Scanned",
    timeline: [
      { time: "8:10 AM", event: "Lead scanned from hipages" },
      { time: "8:10 AM", event: 'Excluded keyword matched: "diy"' },
      { time: "8:10 AM", event: "Score computed: 5" },
      { time: "8:10 AM", event: "Decision: Reject (score below review threshold 20)" },
    ],
  },
  {
    id: "al-6",
    ...
    status: "Processed",
    timeline: [
      { time: "7:15 AM", event: "Lead scanned from hipages" },
      { time: "7:15 AM", event: "Keywords matched: roof, commercial, full replacement, urgent" },
      { time: "7:15 AM", event: "Score computed: 90" },
      { time: "7:15 AM", event: "Decision: Accept (threshold 40)" },
      { time: "7:16 AM", event: "Lead marked as Processed" },
    ],
  },
  {
    id: "al-7",
    ...
    status: "Failed",
    timeline: [
      { time: "6:45 AM", event: "Lead scanned from Oneflare" },
      { time: "6:45 AM", event: "Scan failed: connection timeout during keyword extraction" },
      { time: "6:45 AM", event: "Marked as Failed — manual review required" },
    ],
  },
];
